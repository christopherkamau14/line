            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-certificate"></i>Exam Manager <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu nav-collapse">
                            <li><a href="<c:url value="#"/>">Exam Registration</a></li>
                            <li><a href="<c:url value="#"/>">Marks Recording</a></li>
                            <li><a href="<c:url value="#"/>">Exam Processing</a></li>
                            <li><a href="<c:url value="#"/>">Merge Exams</a></li>
                            <li><a href="<c:url value="#"/>">Combine Subjects</a></li>
                            <li><a href="<c:url value="#"/>">Custom Teacher Comments</a></li>
