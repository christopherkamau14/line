...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "com.high.school" })
@EnableJpaRepositories(repositoryFactoryBeanClass = DataTablesRepositoryFactoryBean.class,basePackages =  "com.high.school")
...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public JavaMailSender getJavaMailSender() {
        ...
        mailSender.setUsername("kamaugaby13@gmail.com");
        mailSender.setPassword("loopoflove");
...
public DataSource getDataSource(){
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.high.school");
